...
# 默认推理模型配置（可通过环境变量覆盖）
DEFAULT_MODEL_NAME="${DEFAULT_MODEL_NAME:-Qwen/Qwen3-0.6B}"
DEFAULT_TOKENIZER_PATH="${DEFAULT_TOKENIZER_PATH:-Qwen/Qwen3-0.6B}"
DEFAULT_TOOL_PARSER="${DEFAULT_TOOL_PARSER:-hermes}"
DEFAULT_REASONING_PARSER="${DEFAULT_REASONING_PARSER:-deepseek_r1}"
