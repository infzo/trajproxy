...
# 归档配置
ARCHIVE_LOCAL_TEMP_PATH="${ARCHIVE_LOCAL_TEMP_PATH:-/tmp/archives}"
ARCHIVE_RETENTION_DAYS="${ARCHIVE_RETENTION_DAYS:-30}"

# S3 配置（从环境变量读取）
ARCHIVE_S3_BUCKET="${ARCHIVE_S3_BUCKET:-my-archive-bucket}"
ARCHIVE_S3_PREFIX="${ARCHIVE_S3_PREFIX:-trajproxy-archives/}"
